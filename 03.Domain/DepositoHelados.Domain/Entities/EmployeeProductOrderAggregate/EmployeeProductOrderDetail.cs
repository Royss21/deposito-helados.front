...
public class EmployeeProductOrderDetail : BaseAudit<int>
{
    ...
    public virtual Guid EmployeeProductOrderId { get; private set; }
    ...
    public void SetEmployeeProductOrderId(Guid employeeProductOrderId) => EmployeeProductOrderId = employeeProductOrderId;
